...
async function createDocumentMapping({ baseUrl, apiKey, workflowId, templateId, pdfSha256, documentName, onboardedBy, signatureTabsPlaced = false }) {
...
module.exports = { buildFormSchema, createForm, createWorkflow, attachN8nProjection, createDocumentMapping };
